...
export default props => {
  ...
  return (
    <Layout pageTitle="About" pageDescription="Learn more about me">
      ...
      <p>You can download my <a href="Caron_CV_Jan2026.pdf" target="blank">CV here</a> and my <a href="Caron_Public_Education_Disabled_Students.pdf" target="blank">JMP here</a>. </p>
